#This program reads the file '/ArabidopsisSubNetwork_GeneList.txt' and put them into objets.
#It is created a Bio::EMBL object and then a Bio::Feature object.
#One file is generated as .gff3 with the gene id and the positions with the repeated sequence in the exons.
#A second file is generated with the genes that do not contained the repeated sequence
